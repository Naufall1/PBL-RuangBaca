...
<div class="action-container d-flex justify-content-between">
    <input type="text" name="search" class="search-fields" id="" placeholder="Cari Dosen">
...
<div class="collection-views d-flex justify-content-between">
    <p class="total-views">
        Menampilkan <?= $lecturer['start']+1 ?>-<?= $lecturer['end'] ?> dari <?= $lecturer['countAll'] ?> koleksi
    </p>
</div>
            ...
            <tr>
                ...
                <td class="more-icon-column">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="#" id="risk-action" name="book" onclick="deleteById('<?= $lt->getNidn(); ?>');" value="">Hapus</a>
                    </div>
                </td>
            </tr>
        <?php
...
<div class="pagination d-flex">
    ...
    <?php
        for ($i=1; $i <= $numPage; $i++) {
    ?>
            <a href="#" name="pagination" class="<?= ($lecturer['page'] == $i) ? 'active':'' ?>" ><?= $i ?></a>
    <?php
        }
    ?>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content modal-custom-single-col">
            ...
            <div class="modal-body">
                <form class=" flex-column d-flex" id="formAddLecturer" method="post" >
                    <div class="modal-form-addbook-area d-flex flex-column">
                        <div class="addbook-input-field input-fields d-flex flex-column">
                            <label for="NIDN">NIDN</label>
                            <input type="text" id="NIDN" name="NIDN" placeholder="Masukkan NIDN">
                        </div>
                        <div class="addbook-input-field input-fields d-flex flex-column">
                            <label for="lecturer_name">Nama Dosen</label>
                            <input required type="text" id="lecturer_name" name="lecturer_name" placeholder="Masukkan Nama Dosen">
                        </div>
                    </div>
        ...
        <div class="modal-content modal-custom-delete">
            ...
            <div class="modal-body">
                <!-- <form class=" flex-column d-flex"> -->
                    <p class="delete-confirmation" mod="lecture">
                        Apakah Anda yakin ingin menghapus Dosen dengan NIDN <span>BK0001</span>?
                    </p>
                    <div class="d-flex modal-button-group" style="gap: 12px;">
