...
<div class="action-container d-flex justify-content-between">
    <input type="text" name="search-shelf" class="search-fields" id="" placeholder="Cari Rak">
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td class="id-column" id=""><?= $cat->getShelfId(); ?></td>
                <td class="title-column"><?= $cat->getShelfCategories(); ?></td>
